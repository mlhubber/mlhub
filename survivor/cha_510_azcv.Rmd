...
In addition to the `r ml_command(azcv, demo)` command, a simple
graphical user interface is provided through the 
`r ml_command(azcv, gui)`
command.  The package supports many computer vision operations
including 
...
The pre-built demonstration will illustrate the capabilities of this
