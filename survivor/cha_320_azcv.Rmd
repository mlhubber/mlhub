...
A demonstration of the capabilities of computer vision is available
through the `r ml_command(azcv, demo)` command. A simple graphical
user interface is provided through the `r ml_command(azcv, gui)`
...
permission). The accuracy is excellent.
