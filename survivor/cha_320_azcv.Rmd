...
in the package. To run the examples yourself, install
[MLHub](https://mlhub.ai) and then install
[azcv](https://github.com/gjwgit/azcv), obtain an Azure Cognitive
Services API key (Chapter \@(azcv)), then copy the command to run it
on your Ubuntu command line. The examples are expanded upon through the
following sections.
