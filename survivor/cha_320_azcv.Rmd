...
cloud API to access closed source pre-built models. The package The package
...
```{r echo=FALSE, cache=TRUE, fig.align="left", out.width="50%"}
include_graphics_url("http://cdn1.thr.com/sites/default/files/2013/11/marina_bay_sands_singapore_a_l.jpg")
```
