...
`r CiteDate(20200220)` The 
`r Link("machine learning hub","https://mlhub.ai")` 
is a platform specifically built on Ubuntu. This
quick start is based on a fresh install of Ubuntu 20.04 LTS.  Some of
the steps may not be necessary if some software is already installed.
